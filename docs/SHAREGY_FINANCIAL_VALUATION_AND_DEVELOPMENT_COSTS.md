...
| **3. Smart Load Hub, BWWP & Aktorik**<br>• Dispatch Hub (`/app/control`) & Live Power Budget<br>• Merit-Order Prioritäten-Kaskade & 24h Fahrplan<br>• BWWP SG-Ready Steuerung & Verdichter-Taktschutz<br>• Sungrow Cloud OpenAPI Inverter Arbitrage | Senior Control Eng.<br>Fullstack Engineer | 80 PT<br>*(~4,0 PM)* | 62.000 € – 78.000 € | 90.000 € – 120.000 € |
| **4. KI-Forecasts & Anomalieerkennung**<br>• 48h Hybrid Physics + ML PV-Ertragsprognose<br>• Haushalts-Lastprognose & Netto-Überschuss<br>• 7-Tage Auto-ML Baseline (Predictive Maintenance)<br>• Live CO₂-Grid-Signal & 8-Regel Alarmzentrale | Senior ML Engineer<br>Data Scientist | 65 PT<br>*(~3,2 PM)* | 52.000 € – 68.000 € | 78.000 € – 105.000 € |
...
| **6. Frontend UI/UX, Sankey & Native Apps**<br>• Responsive React SPA mit flackerfreiem Live-Sankey<br>• Capacitor 7 Android App & W3C Web-Push VAPID<br>• Multi-Language i18n (DE, EN, PL)<br>• Integrierter Support-Desk mit FAQ-Deflection | Senior Frontend Eng.<br>Mobile App Eng.<br>UI/UX Designer | 95 PT<br>*(~4,8 PM)* | 72.000 € – 92.000 € | 105.000 € – 140.000 € |
| **7. QA, Testabdeckung, Security & Compliance**<br>• 100% automatisierte Test Suite (Unit + Integration)<br>• Multi-Tenant RBAC, Audit-Logging & DSGVO-Consent<br>• System-Health-Monitoring Engine & Auto-Watchdog | QA / Test Engineer<br>Security Specialist | 50 PT<br>*(~2,5 PM)* | 38.000 € – 50.000 € | 55.000 € – 75.000 € |
...
| **GESAMT-ENTWICKLUNGSAUFWAND** | **Team: 4–6 Experten** | **635 PT**<br>*(~32 PM)* | **502.000 € – 643.000 €** | **738.000 € – 985.000 €** |
