...
| **Virtueller Summenzähler (NAP 15m)** | 🟢 **Ja** (§ 42b EnWG Zeitreihen-Saldierung, 3 Allokationsmodelle & PDF) | 🟡 Nur Summen-Export | 🔴 Keine | 🔴 Nein | 🔴 Nein | 🔴 Nein | 🔴 Nein |
| **VPP Aggregator & Redispatch 2.0** | 🟢 **Ja** (aFRR/SRL, FCR, Connect+ 96-Fahrplan `PT15M`, Leitsystem Dispatch) | 🔴 Keine VPP-Engine | 🔴 Keine | 🟡 Proprietärer 1K5-Pool | 🟡 Nur Tibber-Laststeuerung | 🔴 Keine | 🔴 Keine |
| **Cloud-Hersteller APIs (Zero-Hardware)** | 🟢 **Ja** (Victron VRM v2, Sungrow OpenAPI, Fronius, SMA, SolarEdge) | 🔴 Nein (Nur Zähler) | 🔴 Nein | 🔴 Nur Heartbeat Box | 🔴 Nur Pulse IR | 🟡 Ja (Abo) | 🟡 HACS |
| **Native Mobile App (Android/iOS)** | 🟢 **Ja** (Capacitor 7, Play Store signiert, Push-Nachrichten FCM) | 🟡 Web-Portal Only | 🔴 Kein Endkunden-App | 🟢 Ja (Native App) | 🟢 Ja (Native App) | 🟡 Nur PWA / Web | 🟢 Home Assistant App |
...
| **Wissensportal & Self-Service Guide** | 🟢 **Ja (9 Kategorien, 25 Deep-Dive Artikel in DE & EN, Profil-Empfehlungen)** | 🔴 Nur Doku für Admins | 🟡 Regulatorische PDFs | 🔴 Nur Support-Hotline | 🟡 FAQ-Center | 🟡 Forum / FAQ | 🟢 Community-Docs |
