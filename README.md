...
[![GitHub Release](https://img.shields.io/github/v/release/smartcuc/ha-sharegy)](https://github.com/smartcuc/ha-sharegy/releases)
...
4. Enter repository URL:
   ```
   https://github.com/smartcuc/ha-sharegy
   ```
