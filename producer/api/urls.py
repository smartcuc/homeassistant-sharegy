...
from producer.api.views import (
    ...
    storage_auto_setup, storage_control, storage_dispatch_now_view,
)
...
urlpatterns = [
    ...
    path(
        "storage/<uuid:storage_id>/control/",
        storage_control,
        name="storage-control",
    ),
    path(
        "storage/<uuid:storage_id>/dispatch-now/",
        storage_dispatch_now_view,
        name="storage-dispatch-now",
    ),
    path(
