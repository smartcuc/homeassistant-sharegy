...
def _get_firebase_app():
    ...
    try:
        ...
        # Auto-Discovery für Standardpfade
        if not cred_path and hasattr(settings, "BASE_DIR"):
            default_config_path = os.path.join(settings.BASE_DIR, "config", "firebase_credentials.json")
            default_root_path = os.path.join(settings.BASE_DIR, "firebase_credentials.json")
            if os.path.exists(default_config_path):
                cred_path = default_config_path
            elif os.path.exists(default_root_path):
                cred_path = default_root_path
