                            ...
                            <div className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-center space-y-4 my-4">
                                ...
                                <div className="pt-2 flex flex-col gap-2">
                                    <button
                                        ...
                                        className="w-full py-2.5 rounded-xl bg-indigo-600 text-white text-xs font-semibold hover:bg-indigo-700 transition shadow-sm cursor-pointer"
                                    >
                                        Jetzt anmelden
                                    </button>
                                    <button
                                        type="button"
                                        onClick={() => setActiveTab("help")}
                                        className="w-full py-2 rounded-xl bg-slate-200/60 dark:bg-slate-800 text-slate-700 dark:text-slate-300 text-xs font-medium hover:bg-slate-200 dark:hover:bg-slate-700 transition cursor-pointer"
                                    >
                                        Kostenloses Wissensportal nutzen
                                    </button>
                                </div>
                            </div>
                        ) : (
                                                ...
                                                <div className="space-y-1.5">
                                                    {deflectionArticles.map((art) => (
                                                        <button
                                                            ...
                                                            onClick={() => {
                                                                onClose();
                                                                navigate(`/app/help/${art.slug}`);
                                                            }}
                                                            className="w-full text-left flex items-center justify-between p-2 rounded-lg bg-white dark:bg-slate-900 border border-indigo-100 dark:border-indigo-900/50 text-xs font-medium text-slate-800 dark:text-slate-200 hover:bg-indigo-50/50 dark:hover:bg-indigo-900/40 transition-colors group cursor-pointer"
                                                        >
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            ...
                                            <div>
                                                <div className="flex items-center justify-between mb-1">
                                                    ...
                                                    {canChoosePriority ? (
                                                        <span className="inline-flex items-center gap-0.5 text-[10px] font-semibold text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-950/50 px-1.5 py-0.5 rounded-md">
                                                            <Crown className="w-2.5 h-2.5" />
                                                            {isStaffOrAdmin ? "Admin" : "Pro"}
                                                        </span>
                                                    ) : (
                                                        <span className="inline-flex items-center gap-0.5 text-[10px] text-slate-400 bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded-md">
                                                ...
                                                {canChoosePriority ? (
                                                    <select
                                                        ...
                                                        className="w-full px-3 py-2 text-xs rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 dark:text-white focus:ring-2 focus:ring-indigo-500"
                                                    >
                                                        <option value="low">🟢 Niedrig (Low - Standard)</option>
                                                        <option value="medium">🟡 Normal (Medium)</option>
                                                        <option value="high">🔴 Hoch (High - Störung)</option>
                                                        {isStaffOrAdmin && (
                                                            <option value="urgent">⚡ Dringend (Urgent)</option>
                                                        )}
                                                    </select>
                                                ) : (
                                                    <div className="w-full px-3 py-2 text-xs rounded-xl border border-slate-200/80 dark:border-slate-700/80 bg-slate-50 dark:bg-slate-800/50 text-slate-600 dark:text-slate-300 flex items-center justify-between">
                                                        <span>🟢 Niedrig (Low)</span>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
                        ...
                        !user ? (
                            <div className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-center space-y-4 my-4">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed max-w-xs mx-auto">
                                        Melde dich an, um deine offenen Tickets und Chat-Verläufe einzusehen.
                                    </p>
                                </div>
                                <button
                                    type="button"
                        ...
                        <div className="space-y-3">
                            <div className="p-4 rounded-xl bg-indigo-50/50 dark:bg-indigo-950/20 border border-indigo-100 dark:border-indigo-900/40 text-center">
                                ...
                                <button
                                    ...
                                    className="mt-3 inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-indigo-600 text-white text-xs font-semibold hover:bg-indigo-700 transition-colors shadow-sm cursor-pointer"
                                >
                                    <span>Wissensportal & Handbuch öffnen</span>
