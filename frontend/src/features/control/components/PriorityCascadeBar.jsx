            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2.5 pt-1">
                {priorityOrder.map((catKey, idx) => {
                    ...
                    return (
                        <div
                            key={catKey}
                            className={`flex items-center justify-between gap-1.5 px-3 py-2 rounded-2xl border ${meta.color} shadow-2xs transition-all duration-150 hover:shadow-xs group w-full min-w-0`}
                        >
                            ...
                            {/* Reorder Controls */}
                            <div className="flex items-center gap-0.5 shrink-0 pl-1 border-l border-black/10 dark:border-white/10 opacity-75 group-hover:opacity-100">
                                <button
                                    type="button"
