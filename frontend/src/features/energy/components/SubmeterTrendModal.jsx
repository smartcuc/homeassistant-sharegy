                    ...
                    <div className="bg-slate-50/80 border border-slate-200/80 rounded-2xl p-5 shadow-2xs space-y-3">
                        <div className="flex items-center justify-between text-xs">
                            <span className="font-bold text-gray-700">
                                {t("submeters.trend_label", "Zeitverlauf")} ({(period === "today" || data?.period_label === "Heute") ? t("energy.period_today", "Heute") : (period === "yesterday" || data?.period_label === "Gestern") ? t("energy.period_yesterday", "Gestern") : (data?.period_label || period)})
                            </span>
