    ...
    function getModelMetadata(modelType) {
        switch (modelType) {
            case "mieterstrom":
                return {
                    id: "mieterstrom",
                    label: t("admin_communities.models.mieterstrom.label", "Mieterstrom (§ 42a EnWG)"),
                    shortLabel: t("admin_communities.models.mieterstrom.shortLabel", "Mieterstrom"),
                    badgeText: t("admin_communities.models.mieterstrom.badgeText", "🏢 Mieterstrom (§ 42a)"),
                    icon: "🏢",
                    badgeClass: "bg-sky-50 dark:bg-sky-950/50 text-sky-700 dark:text-sky-300 border-sky-200 dark:border-sky-800",
                    description: t("admin_communities.models.mieterstrom.description", "Vollversorgung: PV-Strom & Reststrom in einer Monatsabrechnung für Mieter"),
                    membersTitle: t("admin_communities.models.mieterstrom.membersTitle", "Mieter & Wohneinheiten"),
            ...
            case "ggv":
                return {
                    ...
                    membersTitle: t("admin_communities.models.ggv.membersTitle", "Wohnungseigentümer & Parteien"),
            ...
            default:
                return {
                    ...
                    membersTitle: t("admin_communities.models.energy_sharing.membersTitle", "Genossenschaftsmitglieder"),
    ...
    if (loading) {
        return (
            <div className="p-12 text-center text-slate-400 text-sm animate-pulse">
                {t("admin_communities.loading_portfolio", "Lade Multi-Community Portfolio & Performance-Zentralen...")}
            </div>
        );
    }
        ...
        <div className="p-6 max-w-7xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3.5">
                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 shadow-2xs">
                    <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">{t("admin_communities.kpi_communities", "Communities")}</span>
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 shadow-2xs">
                    <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">{t("admin_communities.kpi_participants", "Teilnehmer")}</span>
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 shadow-2xs">
                    <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">{t("admin_communities.kpi_meters", "Zähler (iMSys)")}</span>
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 shadow-2xs">
                    <span className="text-[11px] font-bold text-amber-600 dark:text-amber-400 uppercase tracking-wider">{t("admin_communities.kpi_generation", "Erzeugung")}</span>
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 shadow-2xs">
                    <span className="text-[11px] font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-wider">{t("admin_communities.kpi_autarky", "Autarkiegrad")}</span>
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 shadow-2xs">
                    <span className="text-[11px] font-bold text-cyan-600 dark:text-cyan-400 uppercase tracking-wider">{t("admin_communities.kpi_savings", "Ersparnis")}</span>
            ...
            <div className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <h2 className="text-sm font-bold text-slate-800 dark:text-slate-200 uppercase tracking-wider">
                        {t("admin_communities.managed_units_title", { count: filteredCommunities.length, defaultValue: `Verwaltete Einheiten & Modelle (${filteredCommunities.length})` })}
                    </h2>
                    ...
                    <div className="flex flex-wrap items-center gap-1.5 bg-slate-100 dark:bg-slate-800/80 p-1 rounded-xl text-xs font-semibold">
                        ...
                        >
                            {t("admin_communities.filter_all", { count: portfolioData?.communities?.length || 0, defaultValue: `Alle (${portfolioData?.communities?.length || 0})` })}
                        </button>
                        <button
                            type="button"
                        ...
                        >
                            <span>⚡</span> {t("admin_communities.filter_energy_sharing", "Energy Sharing")}
                        </button>
                    </div>
                </div>
                ...
                {filteredCommunities.length > 0 ? (
                            ...
                            return (
                                ...
                                >
                                    <div className="space-y-3">
                                        ...
                                        <div className="space-y-1 pt-1">
                                            <div className="flex justify-between text-xs font-semibold">
                                                <span className="text-slate-500 dark:text-slate-400">{t("admin_communities.card_autarky", "Autarkiegrad")}</span>
                                        ...
                                        <div className="grid grid-cols-2 gap-2 pt-2 border-t border-slate-100 dark:border-slate-800 text-xs">
                                            <div>
                                                <span className="text-slate-400 text-[10px]">{t("admin_communities.card_month_gen", "Monat Erzeugung")}</span>
                                                <div className="font-bold text-amber-600 dark:text-amber-400">
                                                    ☀️ {Number(c.month_produced_kwh ?? 0).toFixed(1)} kWh
                                                </div>
                                            </div>
                                            <div>
                                                <span className="text-slate-400 text-[10px]">{t("admin_communities.card_onsite_sharing", "Vor-Ort / Sharing")}</span>
                                            ...
                                            <div>
                                                <span className="text-slate-400 text-[10px]">{t("admin_communities.card_active_tariff", "Aktiver Tarif")}</span>
                                                <div className="font-semibold text-indigo-600 dark:text-indigo-400 truncate">
                                                    {c.tariff ? `${Number(c.tariff.sharing_price_ct_kwh ?? 0).toFixed(1)} Ct/kWh` : t("admin_communities.card_tariff_default", "Standard")}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="pt-4 mt-3 border-t border-slate-100 dark:border-slate-800">
                                        ...
                                        >
                                            <span>🔍</span> {t("admin_communities.card_drilldown_btn", "Drill-Down & Verwalten")}
                                        </button>
                                    </div>
                                </div>
                            );
                    ...
                    <div className="text-center py-12 text-slate-400 text-xs bg-slate-50 dark:bg-slate-900 rounded-2xl border border-dashed border-slate-200 dark:border-slate-800">
                        {t("admin_communities.no_communities_found", "Keine Energiegemeinschaften oder Objekte in diesem Filter gefunden.")}
                    </div>
                )}
            </div>
                    ...
                    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl max-w-5xl w-full max-h-[90vh] flex flex-col shadow-2xl overflow-hidden" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="p-5 sm:p-6 border-b border-slate-200 dark:border-slate-800 space-y-4 shrink-0 bg-slate-50/50 dark:bg-slate-900/50">
                            ...
                            <div className="flex flex-wrap bg-slate-100 dark:bg-slate-800/70 p-1 rounded-xl text-xs font-semibold gap-1">
                                ...
                                >
                                    {t("admin_communities.drilldown.tab_members", { title: drilldownMeta.membersTitle, count: drilldownData.members.length, defaultValue: `👥 ${drilldownMeta.membersTitle} (${drilldownData.members.length})` })}
                                </button>
                                <button
                                ...
                                >
                                    {t("admin_communities.drilldown.tab_shares", { title: drilldownMeta.sharesTitle, defaultValue: `⚖️ ${drilldownMeta.sharesTitle}` })}
                                </button>
                                <button
                                ...
                                >
                                    {t("admin_communities.drilldown.tab_tariffs", { title: drilldownMeta.tariffTitle, defaultValue: `💰 ${drilldownMeta.tariffTitle}` })}
                                </button>
                                <button
                                ...
                                >
                                    {t("admin_communities.drilldown.tab_announcements", { count: drilldownData.announcements.length, defaultValue: `📢 Mitteilungen (${drilldownData.announcements.length})` })}
                                </button>
                                <button
                                ...
                                >
                                    {t("admin_communities.drilldown.tab_settings", "⚙️ Einstellungen")}
                                </button>
                            </div>
                        </div>
                                    ...
                                    >
                                        <div className="space-y-1">
                                            ...
                                            <div className="text-slate-400 text-[11px]">
                                                {t("admin_communities.drilldown.meter_label", "Zähler:")} {m.meters.length > 0 ? m.meters.map((mtr) => mtr.serial_number).join(", ") : t("admin_communities.drilldown.no_meter_assigned", "Kein Zähler zugewiesen")}
                                            </div>
                                        </div>

                                        <div className="flex items-center gap-4 text-right">
                                            <div>
                                                <div className="text-[10px] text-slate-400">{t("admin_communities.drilldown.produced_monthly", "Erzeugt (Mtl.)")}</div>
                                                <div className="font-bold text-amber-600 dark:text-amber-400">
                                                    ☀️ {Number(m.month_produced_kwh ?? 0).toFixed(1)} kWh
                                                </div>
                                            </div>
                                            <div>
                                                <div className="text-[10px] text-slate-400">{t("admin_communities.drilldown.consumed_monthly", "Verbraucht (Mtl.)")}</div>
                                            ...
                                            {m.last_statement && (
                                                <div className="pl-3 border-l border-slate-200 dark:border-slate-700">
                                                    <div className="text-[10px] text-slate-400">{t("admin_communities.drilldown.last_balance", "Letzter Saldo")}</div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 space-y-4">
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                                        <div>
                                            <h3 className="font-bold text-sm text-slate-900 dark:text-white">
                                                {t("admin_communities.drilldown.alloc_title", "Allokationsmodell für Solarstrom-Verteilung")}
                                            </h3>
                                            <p className="text-xs text-slate-500 dark:text-slate-400">
                                                {t("admin_communities.drilldown.alloc_desc", "Bestimmt die mathematische Zuweisung von Gemeinschafts-Solarstrom im 15-Minuten-Raster")}
                                            </p>
                                        </div>
                                        <button
                                        ...
                                        >
                                            {savingModel ? t("admin_communities.drilldown.alloc_saving", "Speichere...") : t("admin_communities.drilldown.alloc_save_btn", "Modell im Tarif aktivieren")}
                                        </button>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                                        ...
                                        >
                                            <div className="flex items-center gap-2">
                                                ...
                                                />
                                                <span className="font-bold text-xs">{t("admin_communities.drilldown.alloc_dynamic_title", "🟢 Dynamisch (Lastgang)")}</span>
                                            </div>
                                            <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-2 leading-relaxed">
                                                {t("admin_communities.drilldown.alloc_dynamic_desc", "Solarstrom wird proportional zum zeitgleichen Echtzeit-Verbrauch im 15-Minuten-Raster aufgeteilt.")}
                                            </p>
                                        </label>
                                        ...
                                        >
                                            <div className="flex items-center gap-2">
                                                ...
                                                />
                                                <span className="font-bold text-xs">{t("admin_communities.drilldown.alloc_static_title", "🔵 Statisch (MEA-Quote)")}</span>
                                            </div>
                                            <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-2 leading-relaxed">
                                                {t("admin_communities.drilldown.alloc_static_desc", "Jedes Mitglied erhält eine feste Quote (z. B. nach Miteigentumsanteilen). Ungenutzter Strom geht ins Netz.")}
                                            </p>
                                        </label>
                                        ...
                                        >
                                            <div className="flex items-center gap-2">
                                                ...
                                                />
                                                <span className="font-bold text-xs">{t("admin_communities.drilldown.alloc_hybrid_title", "🟣 Hybrid (Vorrang + Überlauf)")}</span>
                                            </div>
                                            <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-2 leading-relaxed">
                                                {t("admin_communities.drilldown.alloc_hybrid_desc", "Stufe 1: Vorrangige Quote. Stufe 2: Ungenutzte Überschüsse werden dynamisch auf Restbedarf verteilt.")}
                                            </p>
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                                        <div className="flex items-center gap-3">
                                            <h4 className="font-bold text-xs text-slate-900 dark:text-white">
                                                {t("admin_communities.drilldown.shares_title", "Mitglieder-Beteiligungsquoten & MEA-Schlüssel")}
                                            </h4>
                                            <span
                                            ...
                                            >
                                                {t("admin_communities.drilldown.shares_sum_label", { sum: currentSharesSum.toFixed(2), defaultValue: `Summe: ${currentSharesSum.toFixed(2)} %` })} {Math.abs(currentSharesSum - 100) < 0.1 ? t("admin_communities.drilldown.shares_balanced", "🟢 Ausgeglichen") : t("admin_communities.drilldown.shares_unbalanced", "⚠️ Nicht 100%")}
                                            </span>
                                        </div>
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            >
                                                {t("admin_communities.drilldown.normalize_100_btn", "⚖️ Auf 100% normieren")}
                                            </button>
                                            <button
                                                ...
                                                className="px-3.5 py-1.5 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white rounded-xl text-xs font-bold transition cursor-pointer"
                                            >
                                                {savingShares ? t("admin_communities.drilldown.alloc_saving", "Speichere...") : t("admin_communities.drilldown.save_shares_btn", "Quoten speichern")}
                                            </button>
                                        </div>
                                    </div>
                                        ...
                                        <table className="w-full text-left border-collapse">
                                            <thead>
                                                <tr className="bg-slate-50 dark:bg-slate-800/60 border-b border-slate-200 dark:border-slate-800 text-slate-500 dark:text-slate-400 font-semibold">
                                                    <th className="p-3">{t("admin_communities.drilldown.th_member", "Mitglied / E-Mail")}</th>
                                                    <th className="p-3">{t("admin_communities.drilldown.th_share_pct", "Quote (%)")}</th>
                                                    <th className="p-3">{t("admin_communities.drilldown.th_mea", "Miteigentumsanteil (MEA)")}</th>
                                                    <th className="p-3">{t("admin_communities.drilldown.th_kwp", "kWp Zuweisung")}</th>
                                                </tr>
                                            </thead>
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                        <div>
                                            <h4 className="font-bold text-sm">
                                                {t("admin_communities.drilldown.sim_title", "📊 3-Modelle Simulations- & Ertragsvergleich")}
                                            </h4>
                                            <p className="text-xs text-indigo-300">
                                                {t("admin_communities.drilldown.sim_desc", "Vergleicht für diesen Abrechnungsmonat den Ertrag und die Deckungsquoten aller 3 Allokationsmethoden")}
                                            </p>
                                        </div>
                                        <button
                                        ...
                                        >
                                            {previewLoading ? t("admin_communities.drilldown.sim_simulating", "Simuliere...") : t("admin_communities.drilldown.sim_btn", "🔍 Vergleich jetzt berechnen")}
                                        </button>
                                    </div>
                                            ...
                                            {Object.values(previewData.comparison).map((comp) => (
                                                ...
                                                >
                                                    <div className="flex justify-between items-start">
                                                        ...
                                                        {comp.key === selectedAllocationModel && (
                                                            <span className="bg-indigo-500 text-[9px] font-black px-1.5 py-0.5 rounded">{t("admin_communities.drilldown.sim_active_badge", "AKTIV")}</span>
                                                        )}
                                                    </div>
                                                    <div className="mt-3 space-y-1.5 text-xs">
                                                        <div className="flex justify-between text-indigo-200">
                                                            <span>{t("admin_communities.drilldown.sim_shared_power", "Geteilter Strom:")}</span>
                                                            <span className="font-bold text-white">{comp.total_shared_kwh} kWh</span>
                                                        </div>
                                                        <div className="flex justify-between text-indigo-200">
                                                            <span>{t("admin_communities.drilldown.sim_total_savings", "Gesamtersparnis:")}</span>
                                ...
                                <div className="bg-gradient-to-br from-indigo-900 to-slate-900 text-white rounded-2xl p-5">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="bg-white/10 text-indigo-200 text-xs font-semibold px-2.5 py-1 rounded-lg">
                                            {t("admin_communities.drilldown.tariff_model_badge", { model: (drilldownData.active_tariff.allocation_model || "dynamic").toUpperCase(), defaultValue: `Modell: ${(drilldownData.active_tariff.allocation_model || "dynamic").toUpperCase()}` })}
                                        </span>
                                    </div>
                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-4 text-xs">
                                        <div>
                                            <span className="text-indigo-300 text-[10px]">{t("admin_communities.drilldown.tariff_sharing_price", "Bezugspreis (Sharing)")}</span>
                                            <div className="text-lg font-black">{Number(drilldownData.active_tariff.sharing_price_ct_kwh || 0).toFixed(2)} Ct/kWh</div>
                                        </div>
                                        <div>
                                            <span className="text-indigo-300 text-[10px]">{t("admin_communities.drilldown.tariff_producer_payout", "Einspeisevergütung")}</span>
                                        ...
                                        <div>
                                            <span className="text-indigo-300 text-[10px]">{t("admin_communities.drilldown.tariff_community_fee", "Community-Umlage")}</span>
                                        ...
                                        <div>
                                            <span className="text-indigo-300 text-[10px]">{t("admin_communities.drilldown.tariff_grid_reduction", "Netzentgelt-Reduktion")}</span>
                                ...
                                <div className="bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                    <div>
                                        <h4 className="text-xs font-bold text-slate-900 dark:text-white">
                                            {t("admin_communities.drilldown.export_title", "Abrechnungs- & Clearing-Exporte")}
                                        </h4>
                                        <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">
                                            {t("admin_communities.drilldown.export_desc", "Export aller Monatsabrechnungen dieses Quartiers für ERP, DATEV und Buchhaltung")}
                                        </p>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <button
                                        ...
                                        >
                                            <span>📗</span> {exportingFormat === "xlsx" ? t("admin_communities.drilldown.export_exporting", "Exportiere...") : "Excel (.xlsx)"}
                                        </button>
                                        <button
                                            ...
                                            className="px-3 py-1.5 bg-white dark:bg-slate-900 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-semibold transition cursor-pointer flex items-center gap-1.5 shadow-2xs"
                                        >
                                            <span>📊</span> {exportingFormat === "csv" ? t("admin_communities.drilldown.export_exporting", "Exportiere...") : "CSV"}
                                        </button>
                                        <button
                                            ...
                                            className="px-3 py-1.5 bg-white dark:bg-slate-900 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-semibold transition cursor-pointer flex items-center gap-1.5 shadow-2xs"
                                        >
                                            <span>📦</span> {exportingFormat === "xml" ? t("admin_communities.drilldown.export_exporting", "Exportiere...") : "XML / ERP"}
                                        </button>
                                        <button
                                            ...
                                            className="px-3 py-1.5 bg-white dark:bg-slate-900 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-semibold transition cursor-pointer flex items-center gap-1.5 shadow-2xs"
                                        >
                                            <span>📄</span> {exportingFormat === "mscons" ? t("admin_communities.drilldown.export_exporting", "Exportiere...") : "MSCONS (EDI)"}
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between items-center">
                                    <h4 className="text-xs font-bold text-slate-800 dark:text-slate-200">
                                        {t("admin_communities.drilldown.announcements_title", "Community-Rundschreiben & Statusmeldungen")}
                                    </h4>
                                    <button
                                    ...
                                    >
                                        {t("admin_communities.drilldown.new_announcement_btn", "+ Neue Mitteilung posten")}
                                    </button>
                                </div>
                            ...
                            <form onSubmit={saveSettings} className="space-y-4 text-xs">
                                <div>
                                    <label className="block font-semibold text-slate-700 dark:text-slate-300 mb-1">
                                        {t("admin_communities.drilldown.settings_name", "Name der Energiegemeinschaft")}
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label className="block font-semibold text-slate-700 dark:text-slate-300 mb-1">
                                        {t("admin_communities.drilldown.settings_branding", "Branding / Primärfarbe")}
                                    </label>
                                    <div className="flex items-center gap-3">
                                        <input
                                            type="color"
                                ...
                                <div className="pt-2">
                                    ...
                                    >
                                        {savingSettings ? t("admin_communities.drilldown.alloc_saving", "Speichere...") : t("admin_communities.drilldown.settings_save_btn", "Einstellungen übernehmen")}
                                    </button>
                                </div>
                            </form>
                        )}
                ...
                <div className="fixed inset-0 z-60 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4" onClick={() => setAnnouncementModal(false)}>
                    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl max-w-md w-full p-6 space-y-4 shadow-2xl" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={submitAnnouncement} className="space-y-3 text-xs">
                            <div>
                                <label className="block font-semibold text-slate-700 dark:text-slate-300 mb-1">
                                    {t("admin_communities.modal_announcement.subject_label", "Titel / Betreff")}
                                </label>
                                <input
                                    type="text"
                                    placeholder={t("admin_communities.modal_announcement.subject_placeholder", "z. B. Neuer Zählerwechsel-Termin")}
                            ...
                            <div>
                                <label className="block font-semibold text-slate-700 dark:text-slate-300 mb-1">
                                    {t("admin_communities.modal_announcement.category_label", "Kategorie")}
                                </label>
                                <select
                                    ...
                                    className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-slate-900 dark:text-white"
                                >
                                    <option value="info">{t("admin_communities.modal_announcement.cat_info", "ℹ️ Information")}</option>
                                    <option value="tariff">{t("admin_communities.modal_announcement.cat_tariff", "💰 Tarif & Abrechnung")}</option>
                                    <option value="maintenance">{t("admin_communities.modal_announcement.cat_maintenance", "🔧 Wartung & Zähler")}</option>
                                    <option value="important">{t("admin_communities.modal_announcement.cat_important", "⚠️ Wichtig / Dringend")}</option>
                                </select>
                            </div>

                            <div>
                                <label className="block font-semibold text-slate-700 dark:text-slate-300 mb-1">
                                    {t("admin_communities.modal_announcement.message_label", "Nachrichtentext")}
                                </label>
                                <textarea
                                    rows="4"
                                    placeholder={t("admin_communities.modal_announcement.message_placeholder", "Text der Mitteilung an alle Teilnehmer dieser Energiegemeinschaft...")}
                            ...
                            <div className="pt-2 flex justify-end gap-2">
                                ...
                                >
                                    {t("admin_communities.modal_announcement.cancel_btn", "Abbrechen")}
                                </button>
                                <button
                                    type="submit"
                                    className="px-4 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold cursor-pointer"
                                >
                                    {t("admin_communities.modal_announcement.publish_btn", "Veröffentlichen")}
                                </button>
                            </div>
                        </form>
                    </div>
